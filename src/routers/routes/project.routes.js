...
function getDefaultProjectFeatureFlags(studioVersion) {
    return {
        flatTree: true,
        ...
        widgetEnabled: studioVersion === 2 ? false : true // enable widget only for non studio v2
    };
}
...
module.exports = {
    ...
    create: async (req, res) => {
        ...
        try {
            ...
            const studioVersion = initialProject.wizard.settings?.studioVersion ?? 1;
            initialProject.widget = getDefaultProjectFeatureFlags(studioVersion);
